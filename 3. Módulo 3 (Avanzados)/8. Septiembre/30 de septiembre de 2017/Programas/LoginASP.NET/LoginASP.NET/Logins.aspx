...
<body>
  ...
  <div class="container">
    ...
    <form id="form1" runat="server">
        ...
        <button id="btnGuardar" class="btn btn-primary" onclick="registro()">
            Guardar
        </button>
    </form>
        </div>
 <div class="container" style="top:20px">
        ...
        <tbody>
            ...
            <% foreach (System.Data.DataRow registro in Tabla.Rows) 
                ...
                <tr>
                    ...
                    <td><a href="#" class="eliminar" data-id="<%= registro.ItemArray[0] %>">Eliminar</a></td>
                <%}%>
                </tr>
                <%}%>
        </tbody>
    ...
    <script src="/scripts/validador.js?1.1"></script>
</body>
</html>