...
Public Class UsuarioViewModel
    ...
    Private _ElementoSeleccionado As Usuarios
    Private _ElementoContacto As Contactos
    Private _ListaContactos As New ObservableCollection(Of Contactos)
    ...
    Private _DireccionesContacto As New ObservableCollection(Of Contacto_Direcciones)
    Private _EmailContacto As New ObservableCollection(Of Contacto_Email)
    Private _TelefonosContacto As New ObservableCollection(Of Contacto_Telefonos)
    Public Property ElementoSeleccionado As Usuarios
        Get
        ...
        Set(value As Usuarios)
            If value IsNot Nothing Then
                ...
                For Each C In ElementoSeleccionado.Contactos
                    ListaContactos.Add(C)
                Next
            End If
        End Set
    End Property
    Public Property ElementoContacto As Contactos
        Get
            Return _ElementoContacto
        End Get
        Set(value As Contactos)
            _ElementoContacto = value
        End Set
    End Property

    Public Property ListaContactos As ObservableCollection(Of Contactos)
        Get
            Return _ListaContactos
        End Get
        Set(value As ObservableCollection(Of Contactos))
    ...
    Public Property Rol As Integer
        ...
        End Set
    End Property
    Public Property DireccionesContacto As ObservableCollection(Of Contacto_Direcciones)
        Get
            Return _DireccionesContacto
        End Get
        Set(value As ObservableCollection(Of Contacto_Direcciones))
            _DireccionesContacto = value
        End Set
    End Property
    Public Property EmailContacto As ObservableCollection(Of Contacto_Email)
        Get
            Return _EmailContacto
        End Get
        Set(value As ObservableCollection(Of Contacto_Email))
            _EmailContacto = value
        End Set
    End Property
    Public Property TelefonosContacto As ObservableCollection(Of Contacto_Telefonos)
        Get
            Return _TelefonosContacto
        End Get
        Set(value As ObservableCollection(Of Contacto_Telefonos))
